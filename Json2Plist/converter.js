...
var fs=require('fs')
var targetPath = process.argv.splice(2)[0];

var fileName=targetPath.match(/\w+.?js|JSON/ig)[0];
var fileName1=targetPath.match(/\w+.?js|JSON/ig)[0].split('.')[0];
var targerPlistPath=targetPath.replace(fileName,"")+fileName1+".plist";



var jsonStr=fs.readFileSync(targetPath,{encoding:"utf8"});
var jsonObj=eval("temp="+jsonStr);
var result=json2plist(temp);

//fs.writeFileSync(targerPlistPath, result, {encoding:"utf8"});
